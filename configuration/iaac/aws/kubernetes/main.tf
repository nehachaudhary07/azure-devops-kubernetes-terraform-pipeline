...
# terraform-backend-state-in28minutes-12345
# AKIA6MBYKHHI4RSN4UGR
...
module "in28minutes-cluster" {
  ...
  subnet_ids         = ["subnet-0d7cb0f8ca8bd1123", "subnet-0b8ce3b4ac30fb707", "subnet-06523cec4bd4739cf"] #CHANGE # Donot choose subnet from us-east-1e
  vpc_id          = aws_default_vpc.default.id
